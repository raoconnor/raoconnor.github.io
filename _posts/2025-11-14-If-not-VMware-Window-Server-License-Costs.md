# If Not VMware, Then Where? - *Understanding Windows Server License Costs* 
## Part 1
...
*Note: Software Assurance does have a cost, and any TCO model should include that when applying Hybrid Benefit*
